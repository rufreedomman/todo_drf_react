...
const AddTodo = props => {
  ...
  let initialTodoDescription = "";

  if (props.location.state && props.location.state.currentTodo) {
    editing = true;
    initialTodoTitle = props.location.state.currentTodo.title;
    initialTodoDescription = props.location.state.currentTodo.description;
  }

  const [title, setTitle] = useState(initialTodoTitle);
  const [description, setDescription] = useState(initialTodoDescription);
